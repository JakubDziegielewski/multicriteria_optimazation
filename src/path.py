...
class Path:
    def __init__(self, first_node_name: str, last_node_name: str, network: Network):
        ...
        self.edge_path = self.depth_first_search(network, first_node_name, last_node_name)
    ...
    def depth_first_search(self, network: Network, first_node_name:str, last_node_name:str) -> None:
